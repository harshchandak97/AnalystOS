...
function SectorRanking({ ranked, companyResults, onCompanySelect, selectedCompanyId }) {
  ...
  return (
    <div className="mb-8" data-testid="sector-ranking">
      <h2 className="text-xl font-bold text-gray-900 mb-4">Sector Opportunity Ranking</h2>
              ...
              {ranked && ranked.map((item, idx) => {
                ...
                return (
                  <tr
                    ...
                    data-testid={`company-row-${item.company_id}`}
                  >
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      ...
                      <div className="text-xs text-gray-500">{item.company_id}</div>
                    </td>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <span className={`inline-flex px-2 py-1 text-xs font-semibold rounded-full border ${getVerdictBadge(item.verdict)}`}>
                        {item.verdict}
                      </span>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                      <span className={`inline-flex px-2 py-1 text-xs font-medium rounded-full ${getConfidenceBadge(companyDetail?.confidence)}`}>
